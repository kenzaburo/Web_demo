<?php
    ...
    switch($linkI){
		case 1 : $linkI = "ban-an";
		break;
		case 2 : $linkI = "ghe-sofa";
        break;
		case 3 : $linkI = "marquetry"; 
			
		break;
		case 4 : $linkI =  "cua-di";
		break;
		case 5 : $linkI =  "ghe-ngoi";
		break;
		case 6 : $linkI =  "tu-tivi";
			
		break;
		case 7 : $linkI =   "tu-giay-dep";
		...
		break;
		case 10 : $linkI =   "ke-sach";
			
		break;
		case 11 : $linkI =   "giuong-ngu";
    ...
    $link = "http://noithathuyphat.com/noithat/htm/noi-that-do-go-huy-phat/$linkI/";
    if (file_exists($filename)) {
        ...
        $new = '<?xml version="1.0" encoding="utf-8"?>
            <rss version="2.0">
              <channel>
                <title>Nội thất đồ gỗ cao cấp - noithathuyphat.com</title>
